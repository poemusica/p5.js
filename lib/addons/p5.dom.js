...
// =============================================================================
  ...
  p5.Element.prototype.rotate = function(){
    if (arguments.length === 1){
      var style = this.elt.style[transformPrefixed].replace(/rotate3d\(.*\)/g, '');
      style = style.replace(/rotate[X-Z]?\(.*\)/g, '');
      this.elt.style[transformPrefixed] = 'rotate('+arguments[0]+'deg)';
      this.elt.style[transformPrefixed] += style;
    }else if (arguments.length === 2){
      var style = this.elt.style[transformPrefixed].replace(/rotate3d\(.*\)/g, '');
      style = style.replace(/rotate[X-Z]?\(.*\)/g, '');
      this.elt.style[transformPrefixed] = 'rotate('+arguments[0]+'deg, '+arguments[1]+'deg)';
      this.elt.style[transformPrefixed] += style;
    }else if (arguments.length === 3){
      var style = this.elt.style[transformPrefixed].replace(/rotate3d\(.*\)/g, '');
      style = style.replace(/rotate[X-Z]?\(.*\)/g, '');
      this.elt.style[transformPrefixed] = 'rotateX('+arguments[0]+'deg)';
      this.elt.style[transformPrefixed] += 'rotateY('+arguments[1]+'deg)';
      this.elt.style[transformPrefixed] += 'rotateZ('+arguments[2]+'deg)';
      this.elt.style[transformPrefixed] += style;
    }
      return this;
  };
